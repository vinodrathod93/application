...
- (IBAction)DoneThisBeforeAction:(UIButton *)sender
{
    ...
    if(sender.isSelected)
    {
        ...
        NSString *parameterString = [NSString stringWithFormat:@"isConsultingFirstTime=%@&userid=%@&storeid=%@&Sectionid=%@",_Consulting_String,saved_user.userID,[NeediatorUtitity savedDataForKey:kSAVE_STORE_ID],[NeediatorUtitity savedDataForKey:kSAVE_CAT_ID]];
