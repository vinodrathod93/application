...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    self.orderState = [[UILabel alloc] initWithFrame:CGRectMake(8, 8, CGRectGetWidth(self.frame)/2 - 8, 22.f)];
    ...
    self.orderNumber = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.frame)/2, 8, CGRectGetWidth(self.frame)/2 - 8, 22.f)];
    ...
    self.orderDate = [[UILabel alloc] initWithFrame:CGRectMake(8, 38, CGRectGetWidth(self.frame) - 8, 38)];
